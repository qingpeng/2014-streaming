...
HyperLogLog cardinality counting algorithm @cite.  The implementation
used is implemented in khmer, script {\tt sandbox/unique-kmers.py},
using the default error rate of 0.01.
...
v2.1.0 to generate results (@cite).  {\tt bowtie2} was run with
...
coverage.  While streaming error trimming removes at least as many
...
eliminates less of the data set than digital normalization.  This may
